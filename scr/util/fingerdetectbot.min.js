...
var w = {
  detectAppVersion: function (e) {
    ...
    return (
      0 === n.state &&
      (/headless/i.test(n.value)
        ? i.HeadlessChrome
        : /electron/i.test(n.value)
        ? i.Electron
        : /slimerjs/i.test(n.value)
        ? i.SlimerJS
        : void 0)
    );
  },
  detectDocumentAttributes: function (e) {
    ...
    return (
      0 === n.state &&
      (d(n.value, "selenium", "webdriver", "driver") ? i.Selenium : void 0)
    );
  },
  ...
  detectEvalLengthInconsistency: function (e) {
    ...
    if (0 === n.state) {
      ...
      return (
        "unknown" != i &&
        ((37 === t && !a(["webkit", "gecko"], i)) ||
          (39 === t && !a(["internet_explorer"], r)) ||
          (33 === t && !a(["chromium"], i)))
      );
    }
  },
  detectFunctionBind: function (e) {
    if (-2 === e.functionBind.state) return i.PhantomJS;
  },
  detectLanguagesLengthInconsistency: function (e) {
    var n = e.languages;
    if (0 === n.state && 0 === n.value.length) return i.HeadlessChrome;
  },
  detectNotificationPermissions: function (e) {
    var n = e.notificationPermissions;
    return (
      "chrome" === v() && (0 === n.state && n.value ? i.HeadlessChrome : void 0)
    );
  },
  ...
  detectProcess: function (e) {
    ...
    return (
      0 === t.state &&
      ("renderer" === t.value.type ||
      null !=
        (null === (n = t.value.versions) || void 0 === n ? void 0 : n.electron)
        ? i.Electron
        : void 0)
    );
  },
  ...
  detectWindowSize: function (e) {
    ...
    var t = n.value,
      r = t.outerWidth,
      o = t.outerHeight;
    return void 0 !== document.hasFocus &&
      document.hasFocus() &&
      0 === r &&
      0 === o
      ? i.HeadlessChrome
  ...
  detectMimeTypesConsistent: function (e) {
    ...
    if (0 === n.state && !n.value) return i.Unknown;
  },
...
var p = {
    ...
    appVersion: function () {
      ...
      if (null == e) throw new o(-1, "navigator.appVersion is undefined");
      return e;
    },
    rtt: function () {
    ...
    productSub: function () {
      ...
      if (void 0 === e) throw new o(-1, "navigator.productSub is undefined");
      return e;
    },
    ...
    mimeTypesConsistent: function () {
      ...
      for (
        var e = navigator.mimeTypes,
          n = Object.getPrototypeOf(e) === MimeTypeArray.prototype,
          t = 0;
        t < e.length;
        t++
      )
    ...
    webGL: function () {
      ...
      if (null === n) throw new o(-4, "WebGLRenderingContext is null");
    ...
    distinctiveProps: function () {
      var e,
        n,
        t =
          (((e = {})[i.Awesomium] = { window: ["awesomium"] }),
          (e[i.Cef] = { window: ["RunPerfTest"] }),
          (e[i.CefSharp] = { window: ["CefSharp"] }),
          (e[i.CoachJS] = { window: ["emit"] }),
          (e[i.FMiner] = { window: ["fmget_targets"] }),
          (e[i.Geb] = { window: ["geb"] }),
          (e[i.NightmareJS] = { window: ["__nightmare", "nightmare"] }),
          (e[i.Phantomas] = { window: ["__phantomas"] }),
          (e[i.PhantomJS] = { window: ["callPhantom", "_phantom"] }),
          (e[i.Rhino] = { window: ["spawn"] }),
          (e[i.Selenium] = {
            window: [
          ...
          (e[i.WebDriverIO] = { window: ["wdioElectron"] }),
          (e[i.WebDriver] = {
            window: [
              "webdriver",
              "__webdriverFunc",
        ...
        a = c(window),
        u = [];
      for (n in (void 0 !== window.document && (u = c(window.document)), t)) {
        var s = t[n];
        if (void 0 !== s) {
          var l = void 0 !== s.window && d.apply(void 0, r([a], s.window, !1)),
            f =
              !(void 0 === s.document || !u.length) &&
              d.apply(void 0, r([u], s.document, !1));
          o[n] = l || f;
        }
      }
      return o;
        ...
        return n(this, void 0, void 0, function () {
          ...
          return t(this, function (u) {
            switch (u.label) {
              ...
              case 1:
                return u.sent(), (this.components = r), [2, this.components];
            }
          });
        });
      }),
...
function h(e) {
  return (
    (void 0 === e ? {} : e).monitoring,
    n(this, void 0, void 0, function () {
      var e;
      return t(this, function (n) {
        switch (n.label) {
          case 0:
            return [4, (e = new m()).collect()];
          case 1:
            return n.sent(), [2, e];
        }
      });
...
var g = { load: h };
export { i as BotKind, o as BotdError, g as default, h as load, p as sources };
